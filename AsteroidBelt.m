...
%Setup variables
N = 8; %Set this to 6 and you get the normal orbits of a Sun Earth Moon system
dt = 30*60*24;
tmax = 4 * 365 * 60 * 60 * 24;
clockmax = ceil(tmax/dt);

G = 6.6738E-11;
M = [1.989E30, 3.285E23, 4.867E24, 5.9736E24, 7.349E22, 6.39E23, 2.31E21, 2.31E29]; %2.31E21
DAS = 2.2 * 149597870700;
Ra = [0, 5.791E10, 1.082E11, 1.5e11, 384400000, 2.279E11, DAS];
Rb = [0, 5.791E10, 1.082E11, 1.5e11, 384400000, 2.279E11, DAS];
DP = 2*DAS;

%positions: Sun, Mercury, Venus, Earth, Moon, Mars

%angles = [0,259.32,63.71,166.59,180,29.09];
angles = [0,90,180,0,0,180,0];
%angles = [0,0,0,0,0,0];
